...
BOARD_KERNEL_CMDLINE := video=vfb:640x400,bpp=32,memsize=3072000 disable_dma32=on swinfo.fingerprint=fuxi:15/OS2.0.3.0.VMCCNXM:user mtdoops.fingerprint=fuxi:15/OS2.0.3.0.VMCCNXM:user
